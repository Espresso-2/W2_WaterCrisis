...
namespace Water2D
{
    ...
    public class Water2D_Spawner : MonoBehaviour
    {
        ...
        /// The water material.
        /// </summary>
        [Header("Material & color")] public Material WaterMaterial;
        ...
        [ButtonAttribute("Stop and restore", "Water2D.Water2D_Spawner", "StopSpawner")]
        public bool btn_1;
        ...
        [Separator()] [ButtonAttribute("Help?", "Water2D.Water2D_Spawner", "askHelp")]
        public bool btn;
        ...
        private List<microSpawn> microSpawns;
